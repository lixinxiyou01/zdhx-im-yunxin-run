...
public class AdvancedTeamInfoActivity extends UI implements
    ...
    private TextView temp_text_with;
    ...
    private void findViews() {
        ...
        temp_text_with = (TextView) findViewById(R.id.temp_text_with);
    ...
    private void updateTeamInfo(final Team t) {
        ...
        temp_text_with.setText(NimUserInfoCache.getInstance().getUserName(team.getCreator()) + "创建于");
