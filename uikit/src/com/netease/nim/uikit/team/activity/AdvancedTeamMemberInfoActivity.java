...
import static com.netease.nim.uikit.contact_selector.activity.ContactSelectActivity.RESULT_CHOSESCHOOL;
...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
    ...
    private Button removeBtn,top2pBT;
    ...
    private void findViews() {
        ...
        top2pBT = (Button) findViewById(R.id.top2pBT);
        setClickListener();
    }
    ...
    private void setClickListener() {
        ...
        top2pBT.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.top2pBT) {
//            NimUIKit.startChatting(AdvancedTeamMemberInfoActivity.this, account, SessionTypeEnum.P2P, null, null);
            Intent intent = new Intent("com.zdhx.im.UserProfileActivity");
