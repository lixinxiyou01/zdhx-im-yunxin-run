...
public class IntentUtilForUikit {
...

	{
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
			Uri fileUri = FileProvider.getUriForFile(context, "com.pgyersdk.zdhx.provider", new File(param));//android 7.0以上
...

	{
		...
		{
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
				Uri fileUri = FileProvider.getUriForFile(context, "com.pgyersdk.zdhx.provider", new File(paramString));//android 7.0以上
