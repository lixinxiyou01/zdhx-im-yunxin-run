...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private static final int TAG_CHOOSE_MUSIC = 20; // 选择声音
    ...
    private SettingTemplate choseMusicItem;
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            ...
            case TAG_ABOUT:
                ...
                break;
            case TAG_CLEAR:
                ECAlertDialog buildAlert = ECAlertDialog.buildAlert(SettingsActivity.this, R.string.intent_xlt_opendownload, null, new DialogInterface.OnClickListener() {
                ...
                buildAlert.setMessage("是否清空聊天记录");
