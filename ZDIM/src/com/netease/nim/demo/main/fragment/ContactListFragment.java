...
import zhwx.ui.contact.DcContactActivity;
...
public class ContactListFragment extends MainTabFragment {
    ...
    public final static class FuncItem extends AbsContactItem {
        ...
        static final FuncItem SCHOOL = new FuncItem();
        static final FuncItem CLASS = new FuncItem();
        ...
        public static final class FuncViewHolder extends AbsContactViewHolder<FuncItem> {
            ...
            public void refresh(ContactDataAdapter contactAdapter, int position, FuncItem item) {
                if (item == VERIFY) {
                    ...
                    funcName.setText("组织结构");
                    image.setImageResource(R.drawable.ic_tree_organization);
                }  else if (item == CLASS) {
                    funcName.setText("班级");
                    image.setImageResource(R.drawable.ic_tree_organization);
                }
        ...
        static List<AbsContactItem> provide() {
            ...
            items.add(VERIFY); //验证提醒
            items.add(MY_COMPUTER); //我的电脑
            items.add(ADVANCED_TEAM); //群
        ...
        static void handle(Context context, AbsContactItem item) {
            if (item == VERIFY) {
                ...
                context.startActivity(new Intent(context, DcContactActivity.class).putExtra("kind", DcContactActivity.KIND_SCHOOL));
            } else if (item == CLASS) {
                context.startActivity(new Intent(context, DcContactActivity.class).putExtra("kind", DcContactActivity.KIND_CLASS));
            }
        }
    }
