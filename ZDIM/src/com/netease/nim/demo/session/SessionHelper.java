...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
            ...
            //TODO 定制加号点开后可以包含的操作， 默认已经有图片，视频等消息了
            ArrayList<BaseAction> actions = new ArrayList<>();
//            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
//                actions.add(new AVChatAction(AVChatType.AUDIO));
//                actions.add(new AVChatAction(AVChatType.VIDEO));
//            }
//            actions.add(new RTSAction()); //b白板
            actions.add(new SnapChatAction());
//            actions.add(new GuessAction());//猜拳
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarLongClicked(Context context, IMMessage message) {
                //TODO 一般用于群组@功能，或者弹出菜单，做拉黑，加好友等功能
//                if (message.getSessionType() == SessionTypeEnum.Team && !message.getFromAccount().equals(ECApplication.getInstance().getCurrentIMUser().getAccId())) {
//                    MessageFragment.getInputPanel().insertAitMember(message.getFromAccount());
//                    TeamMessageFragment.putAitMembers(message.getFromAccount());
//                }
            }
        };
