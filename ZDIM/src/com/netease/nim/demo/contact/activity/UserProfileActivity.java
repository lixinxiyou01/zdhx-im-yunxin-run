...
//        accountText.setVisibility(View.GONE);
        ...
        Log.e("userAccount", userInfo.getName() + "Account:" + userInfo.getAccount() + "Avatar:" + userInfo.getAvatar());
        accountText.setText("签名：" + (StringUtil.isBlank(userInfo.getSignature())?"未填写":userInfo.getSignature()));
