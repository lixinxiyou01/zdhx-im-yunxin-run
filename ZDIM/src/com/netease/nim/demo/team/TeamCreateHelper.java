...
public class TeamCreateHelper {
     ...
     * 创建讨论组
     */
    public static void createNormalTeam(final Context context, String teamName,List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<Void> callback) {
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, TeamTypeEnum.Normal, "",memberAccounts).setCallback(
