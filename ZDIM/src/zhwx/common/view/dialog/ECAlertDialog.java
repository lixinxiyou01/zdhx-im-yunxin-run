 ...
 */
package zhwx.common.view.dialog;
...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
     ...
     * @return
     */
    public static ECAlertDialog buildColorButtonAlert(Context ctx,CharSequence title,String titleColor,CharSequence message,CharSequence left,String leftColor
            ,CharSequence right,String rightColor, OnClickListener leftListener,OnClickListener rightListener) {
        ECAlertDialog dialog = new ECAlertDialog(ctx);
        dialog.setMessage(message);
        dialog.setTitle(title, titleColor);
        dialog.setButton(BUTTON_NEGATIVE, left, leftColor, leftListener);
        dialog.setButton(BUTTON_POSITIVE, right, rightColor, rightListener);
        return dialog;
    }
     ...
     * @return
     */
    public final Button setButton(int id ,CharSequence text ,String colorString, OnClickListener listener) {
        Button button = mButtons.get(id);
        button.setText(text);
        if (StringUtil.isNotBlank(colorString)) {
