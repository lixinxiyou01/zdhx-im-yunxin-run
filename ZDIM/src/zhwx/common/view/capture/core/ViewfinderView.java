...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		paintCorner.setStrokeWidth(6);
		canvas.drawLine(frame.left-2.5f, frame.top, frame.left + 40, frame.top, paintCorner);
		canvas.drawLine(frame.left, frame.top, frame.left, frame.top+40, paintCorner);
		canvas.drawLine(frame.right-40, frame.top, frame.right+2.5f, frame.top, paintCorner);
		canvas.drawLine(frame.right, frame.top, frame.right, frame.top+40, paintCorner);
		canvas.drawLine(frame.left-2.5f, frame.bottom, frame.left+40, frame.bottom, paintCorner);
		canvas.drawLine(frame.left, frame.bottom-40, frame.left, frame.bottom, paintCorner);
		canvas.drawLine(frame.right-40, frame.bottom, frame.right+2.5f, frame.bottom, paintCorner);
		canvas.drawLine(frame.right, frame.bottom-40, frame.right, frame.bottom, paintCorner);
