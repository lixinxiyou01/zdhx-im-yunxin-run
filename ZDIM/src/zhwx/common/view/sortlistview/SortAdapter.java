...
public class SortAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if(view == null) {
			...
			viewHolder.tvHead = (ImageView) view.findViewById(R.id.headimgIV);
		...
		viewHolder.tvHead.setImageResource(R.drawable.defult_head_img);
		imageLoader.DisplayImage(ECApplication.getInstance().getAddress() + this.list.get(position).getImgSrc(), viewHolder.tvHead, false);
