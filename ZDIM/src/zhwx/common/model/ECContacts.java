...
public class ECContacts  implements Parcelable {
    ...
    public ContentValues buildContentValues() {
        ...
        values.put(AbstractSQLManager.ContactsColumn.IM_ID, this.imId);
        values.put(AbstractSQLManager.ContactsColumn.V3_ID, this.v3Id);
        values.put(AbstractSQLManager.ContactsColumn.PINYIN, this.pinyin);
        return values;
    }
    ...
    public static Creator<ECContacts> getCREATOR() {
        return CREATOR;
    }
