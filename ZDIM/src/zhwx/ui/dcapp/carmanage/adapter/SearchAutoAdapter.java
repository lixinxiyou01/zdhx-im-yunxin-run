...
import zhwx.ui.dcapp.carmanage.AddressActivity;
...
public class SearchAutoAdapter extends BaseAdapter {
	...
	public SearchAutoAdapter(Context context, int maxMatch,OnClickListener onClickListener) {
	...
	public void initSearchHistory() {
		SharedPreferences sp = mContext.getSharedPreferences(
				AddressActivity.SEARCH_HISTORY, 0);
		String longhistory = sp.getString(AddressActivity.SEARCH_HISTORY, "");
