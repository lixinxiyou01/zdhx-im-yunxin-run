...
public class IdAndNameSpinnerAdapterAdd extends ArrayAdapter<IdAndName>{
	private Activity context;
	private List<? extends IdAndName> list;
	
	public IdAndNameSpinnerAdapterAdd(Activity context, List<? extends IdAndName> area) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		tv.setText(getItem(position).getName() + " [" + getItem(position).getQuantity() +"]");
		return item;
	}
