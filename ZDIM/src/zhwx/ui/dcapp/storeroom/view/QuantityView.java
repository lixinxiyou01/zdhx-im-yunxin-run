package zhwx.ui.dcapp.storeroom.view;
...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    private String labelDialogTitle = "输入数量";
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        addButtonBackground = getContext().getResources().getDrawable(R.drawable.qv_btn_selector);
        ...
        removeButtonBackground = getContext().getResources().getDrawable(R.drawable.qv_btn_selector);
        ...
        quantity = a.getInt(R.styleable.QuantityView_qv_quantity, 1);
        maxQuantity = a.getInt(R.styleable.QuantityView_qv_maxQuantity, Integer.MAX_VALUE);
        minQuantity = a.getInt(R.styleable.QuantityView_qv_minQuantity, 1);

        quantityPadding = (int) a.getDimension(R.styleable.QuantityView_qv_quantityPadding, pxFromDp(18));
...
//        quantityBackground = ContextCompat.getDrawable(getContext(), R.drawable.qv_bg_selector);
        quantityBackground = getContext().getResources().getDrawable(R.drawable.qv_bg_selector);
        ...
        mButtonAdd.setPadding(dp10, dp5, dp10, dp5);
        ...
        mButtonRemove.setPadding(dp10, dp5, dp10, dp5);
    ...
    public void setQuantityTextColorRes(int quantityTextColorRes) {
        this.quantityTextColor = getContext().getResources().getColor(quantityTextColorRes);
        mTextViewQuantity.setTextColor(quantityTextColor);
    }
...
//        this.addButtonTextColor = ContextCompat.getColor(getContext(), addButtonTextColorRes);
        this.addButtonTextColor = getContext().getResources().getColor(addButtonTextColorRes);
        mButtonAdd.setTextColor(addButtonTextColor);
    }
    ...
    public void setRemoveButtonTextColorRes(int removeButtonTextColorRes) {
        this.removeButtonTextColor = getContext().getResources().getColor(removeButtonTextColorRes);
        mButtonRemove.setTextColor(removeButtonTextColor);
    }
