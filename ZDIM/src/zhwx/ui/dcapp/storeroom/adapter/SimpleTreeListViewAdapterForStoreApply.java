package zhwx.ui.dcapp.storeroom.adapter;
...
public class SimpleTreeListViewAdapterForStoreApply<T> extends TreeListViewAdapter<T> {
	
	private  BaseActivity context;
	
	public SimpleTreeListViewAdapterForStoreApply(ListView tree, BaseActivity context,
...
//		if(node.isLeaf()){
//			holder.textView.setTextColor(context.getResources().getColor(R.color.main_bg_assets));
//		}else{
