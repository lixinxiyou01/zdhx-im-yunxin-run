...
public class SimpleTreeListViewAdapterForStore<T> extends TreeListViewAdapter<T> {
	
	private  BaseActivity context;
	
	private OnTreeNodeClickListener listener;
	
	public SimpleTreeListViewAdapterForStore(ListView tree, BaseActivity context,
